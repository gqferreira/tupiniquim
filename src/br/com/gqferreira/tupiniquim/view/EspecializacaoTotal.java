 ...
 * @author gustavo
 */
public class EspecializacaoTotal extends Especializacao {

    public EspecializacaoTotal(ControllerConceitual controllerConceitual, Entidade altoNivel) {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("T", this.getWidth() - 10, 13);
