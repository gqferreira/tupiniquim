 ...
 * @author gustavo
 */
public class AtributoComposto extends Atributo {

    public AtributoComposto(int x, int y, Graphics g, Componente componentePai, LigacaoAtributo ligacao, ControllerConceitual controllerConceitual) {
    ...
    public AtributoComposto(int x, int y, Graphics g, Componente componentePai, LigacaoAtributo ligacao, ControllerConceitual controllerConceitual, String nome) {
        super(componentePai, ligacao, controllerConceitual);
        this.nome = nome;
        //Esse objeto Graphics eh do palco, ser utilizado somente por causa do getFontMetrics no construtor
        //ja que nesse ponto o objeto Atributo nao pode retornar um objeto Graphics valido
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.esquerda) {
            ...
            g.fillOval(this.getWidth()-13, 5, 7, 7);
